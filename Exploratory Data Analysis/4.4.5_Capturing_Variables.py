################################
# Değişkenlerin Yaklanması ve işlemlerin genelleştirilmesi
################################
...
def grab_col_names(dataframe, cat_th=10, car_th=20):
    """
    Veri setindeki kategorig, numerik ve kategorik fakat kardinal değişkenlerin isimlerini verir
    Parameters
    ----------
    dataframe: dataframe
    ...
    car_th: int, float
        kategorig fakat kardinal değişkenler için sınıf değeri
    Returns
    -------
    cot_cols: List
    ...
    Notes
    ------
    cat_cols non_cols + cot but_cor = toplon dag sken sayes
